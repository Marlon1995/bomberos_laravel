              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="title_right">
                        <div class="col-md-6 col-sm-12 col-xs-12 form-group pull-right top_search">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Buscar por.." value="" id="tbUsers_InpBuscar">
                  ...
                  <p class="col-md-6 col-sm-12 col-xs-12">
                        <a href="#" class="btn btn-outline-primary" data-toggle="modal" data-target="#mdlUser__new"> <i class="fa fa-user"></i> Agregar</a>
                  ...
                  <table id="tbUsers" class="table table-striped jambo_table bulk_action" style="width:100%">
                    ...
                    @forelse ($users as $item)
                        <tr class="even pointer">
                         ...
                         <td><label class="a-center nombre">{{$item->nombre}}</label> <label class="apellido">{{$item->apellido}}</label></td>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="col-md-12 col-sm-12 col-xs-12">
                     <div class="x_panel">
                         <div class="x_content">
                             <form class="form-horizontal form-label-left"  method="POST" action="{{ route('users.update', 1)}}">
                                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                 ...
                                 <div class="item form-group">
                                     ...
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="cedula" name="cedula" value="" class="form-control" required="required">
                                     </div>
                                 </div>
                                 ...
                                 <div class="item form-group">
                                     ...
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="nombre" name="nombre"  onKeyPress="return fn_aceptaNum(event)"  value="" required="required" class="form-control">
                                     </div>
                                 ...
                                 <div class="item form-group">
                                     ...
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="apellido" name="apellido" value="" required="required" class="form-control">
                                     </div>
                                     {{-- <div class="alert">please put something here</div> --}}
                                 </div>
                                 <div class="item form-group">
                                     ...
                                     <div class="col-md-6 col-sm-6">
                                         ...
                                         <p>M: <input type="radio" class="flat" name="sexo" id="genderM" value="M" checked data-parsley-multiple="gender" style="position: absolute; opacity: 0;">
                                 ...
                                 <div class="item form-group">
                                     ...
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="telefono" name="telefono" value="" required="required" class="form-control">
                                     </div>
                                 </div>
                                 <div class="item form-group">
                                     <label class="col-form-label col-md-3 col-sm-3 label-align" for="direccion">Direcci&oacute;n </label>
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="direccion" name="direccion" value="" required="required" class="form-control">
                                     </div>
                                 </div>
                                 <div class="item form-group">
                                 ...
                                 <div class="form-group">
                                     <div class="col-md-6 offset-md-3">
                                         ...
                                         <button id="send" type="submit" class="btn btn-success">Guardar Informaci&oacute;n</button>
                                     </div>
                                 </div>
                             </form>
                         </div>
                         ...
                         <div class="x_content">
                             <form class="form-horizontal form-label-left"  method="POST" action="{{ route('users.store') }}">
                                 ...
                                 <div class="item form-group">
                                     <label class="col-form-label col-md-3 col-sm-3 label-align" for="cedula">C&eacute;dula </label>
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="cedula" name="cedula" value=""  onKeyPress="return fn_aceptaNum(event)" class="form-control" required="required">
                                     </div>
                                 </div>
                                 ...
                                 <div class="item form-group">
                                     <label class="col-form-label col-md-3 col-sm-3 label-align" for="nombre">Nombre </label>
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="nombre" name="nombre"  value=""  onKeyPress="return fn_aceptaLETRAS(event)" required="required" class="form-control">
                                     </div>
                                     {{-- <div class="alert">please put something here</div> --}}
                                 </div>
                                 <div class="item form-group">
                                     <label class="col-form-label col-md-3 col-sm-3 label-align" for="apellido">Apellido </label>
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="apellido" name="apellido" value="" onKeyPress="return fn_aceptaLETRAS(event)" required="required" class="form-control">
                                     </div>
                                     {{-- <div class="alert">please put something here</div> --}}
                                 </div>
                                 <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                     <label class="col-form-label col-md-3 col-sm-3 label-align" for="telefono">Tel&eacute;fono </label>
                                     <div class="col-md-6 col-sm-6">
                                         <input type="text" id="telefono" name="telefono" value="" onKeyPress="return fn_aceptaNum(event)"  required="required" class="form-control">
                                     </div>
                                 </div>
                                 <div class="item form-group">
                                     <label class="col-form-label col-md-3 col-sm-3 label-align" for="direccion">Direcci&oacute;n </label>
 ...
 @section('scrpts-jqrey')
    <script>
        ...
        $(".mdlUser__edit").on('click', function () {
            ...
            if( $sexo == 'M'){  $("#genderM").attr('checked', true); }
            if( $sexo == 'F'){  $("#genderF").attr('checked', true); }
