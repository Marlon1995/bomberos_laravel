                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            @if( auth()->user()->hasRoles([4]))
                                <a href="#" class="btn btn-outline-primary" data-toggle="modal" data-target="#mdlNuevEmpleado"> <i class="fa fa-user"></i> Agregar</a>
                            @endif
                                     ...
                                     @forelse ($clients as $item)
                                            ...
                                            <td style="	white-space:nowrap;">
                                                ...
                                                @if( $item->estado == 2 )
                                                    <div style="width: 130px">
                                                        <a href="clients/{{$item->id}}" class="btn btn-primary"><i class="fa fa-file-text-o"></i></a>
                                                        <a href="#" class="btn btn-warning mdlModificaEmpleado" data-toggle="modal" data-idmodCli="{{$item->id}}" data-target="#mdlModificaEmpleado"><i class="fa fa-edit" ></i></a>
                                                    </div>
                                                    @endif
                                                ...
                                                @if( $item->estado == 4 || $item->estado == 6 )
                                                    <div style="width: 130px">
                                                        <form method="POST" action="{{ route('clients.update', $item->id )}}">
                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <input type="hidden" name="caso" value="solicitar">
                                                            {!! method_field('PUT') !!}
                                                            <button type="submit" class="btn btn-info"><i class="fa fa-envelope-o" style="color: white;"></i></button>
                                                ...
                                                @if( $item->estado == 5 )
                                                    <div style="width: 130px">
                                                        <form method="POST" action="{{ route('clients.update', $item->id )}}">
                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <input type="hidden" name="caso" value="update_emitir">
                                                            {!! method_field('PUT') !!}

                                                            <a href="clients-edit/{{$item->id}}" class="btn btn-primary"><i class="fa fa-file-text-o"></i></a>
                                                            <a href="#" class="btn btn-warning mdlModificaEmpleado" data-toggle="modal" data-idmodCli="{{$item->id}}" data-target="#mdlModificaEmpleado"><i class="fa fa-edit" ></i></a>
                                                            <button type="submit" class="btn btn-success"><i class="fa fa-check-circle" style="color: white;"></i></button>
                                                        </form>
                                                    </div>
                                                    @endif
                                        ...
                                        @if( auth()->user()->hasRoles([3]))
                                            @if( $item->estado == 4 ||  $item->estado == 6 ||  $item->estado == 7 ||  $item->estado == 8)
                                                ...
                                                <td class="a-center" style="width: 10%">{{ $item->razonSocial }}</td>
                                                <td class="a-center" style="width: 15%">{{ $item->representanteLegal }}</td>
                                                ...
                                                <td style="	white-space:nowrap;">
                                                    @if( $item->estado == 6 )
                                                        <form method="POST" action="{{ route('clients.update', $item->id )}}">
                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <input type="hidden" name="caso" value="autorizar_reinspeccion">
                                                    ...
                                                    @if( $item->estado == 4 )
                                                              <form method="POST" action="{{ route('clients.update', $item->id )}}">
                                                                ...
                                                                <input type="hidden" name="caso" value="autorizar_reinspeccion">
                                                                {!! method_field('PUT') !!}
                                                                <a href="{{route('permiso-funcionamiento.show' , $item->id)}}" class="btn btn-success" >Emitir</a>

                                                                <button type="submit" class="btn btn-warning">Reinspecci&oacute;n</button>
                                                    ...
                                                    @if( $item->estado == 8 )
                                                            ...
                                                            <form method="POST" action="{{ route('clients.update', $item->id )}}">
                                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                <input type="hidden" name="caso" value="revertir_permiso">
                                                                {!! method_field('PUT') !!}
                                                                <button type="submit" class="btn btn-danger btn-block">Revertir Permiso</button>
                                                            </form>
                                                 ...
                                                 <td>
                                                    ...
                                                    @if( $item->estado == 8 )
                                                        <a href="permiso/{{$item->id}}" class="btn btn-info" target="_blank" ><i class="fa fa-eye"></i></a>
                                                    @endif

                                                    @if( $item->estado == 7 )
                                                        <a href="#" class="btn btn-outline-info mdlInfroPago__Client"
                                                           data-toggle="modal"
             ...
             <div class="modal-body">
                 ...
                 <div class="x_panel">
                     ...
                     <div class="x_content">
                         ...
                         <form class="form-horizontal form-label-left" method="POST" action="{{ route('clients.store')}}">
                             <input type="hidden" name="_token" value="{{ csrf_token() }}">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-md-6 col-sm-6 ">
                                     <input type="text" name="ruc" id="ruc" onKeyPress="return fn_aceptaNum(event)"  class="form-control col-md-5" required>
                                  </div>
                             </div>
                             <div class="form-group row">
                                 <label class="control-label col-md-4 col-sm-4 ">RAZ&Oacute;N SOCIAL <small>(NOMBRE COMERCIAL)</small> </label>
                                 <div class="col-md-8 col-sm-8 ">
                                     <input type="text" name="razonSocial" id="razonSocial"   class="form-control col-md-11" required>
                                 </div>
                             </div>
                             <div class="form-group row">
                                 <label class="control-label col-md-4 col-sm-4 ">REPRESENTANTE LEGAL <small>(PROPIETARIO)</small> </label>
                                 <div class="col-md-8 col-sm-8 ">
                                     <input type="text" name="representanteLegal" id="representanteLegal" onKeyPress="return fn_aceptaLETRAS(event)"  class="form-control col-md-11" required>
                                 </div>
                             </div>
                             <div class="form-group row">
                                 ...
                                 <div class="col-md-6 col-sm-6 ">
                                     ...
                                     <input type="text" name="barrio" id="barrio"  onKeyPress="return fn_aceptaLETRAS(event)" class="form-control col-md-6" required>
                                 </div>
                             </div>
                             <div class="form-group row">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-md-3 col-sm-3 ">
                                     <input type="text" name="telefono" id="telefono"   onKeyPress="return fn_aceptaNum(event)"class="form-control col-md-10" required>
                                 </div>
                             </div>
                             <div class="form-group row">
                                 <label class="control-label col-md-2 col-sm-2">E-MAIL: </label>
                                 <div class="col-md-7 col-sm-7 ">
                                     <input type="email" name="email" id="email" class="form-control col-md-10" required>
                                 </div>
                             </div>
                     ...
                     <div class="x_content">
                         ...
                         <form class="form-horizontal form-label-left" method="POST" action="{{ route('clients.update', 1)}}">
                                 ...
                                 <div class="col-12">
                                     <div class="form-group">
                                         <div class="col-md-3 col-sm-3 ">
                                             <div class="checkbox">
                                                 <label>
                                                     <input type="radio" name="tipoInspecion" id="tipoInspecion_md" value="1" class="flat" checked> INSPECCI&Oacute;N
                                                 </label>
                                             </div>
                                         </div>
                                         <div class="col-md-3 col-sm-3 ">
                                             <div class="checkbox">
                                                 <label>
                                                     <input type="radio" name="tipoInspecion" id="tipoInspecion_md" value="2" class="flat"> RE-INSPECCI&Oacute;N
                                                 </label>
                                             </div>
                                         </div>
                                         <div class="form-group">
                             ...
                             <div class="form-group row">
                                 <label class="control-label col-md-4 col-sm-4 ">RUC</label>
                                 <div class="col-md-6 col-sm-6 ">
                                     <input type="text" name="ruc" id="ruc_md"  onKeyPress="return fn_aceptaNum(event)" value="" class="form-control col-md-5" value="" required disabled="">
                                 </div>
                             </div>
                             <div class="form-group row">
                                 <label class="control-label col-md-4 col-sm-4 ">RAZ&Oacute;N SOCIAL <small>(NOMBRE COMERCIAL)</small> </label>
                                 ...
                                 <div class="container">
                                     ...
                                     <div class="row" style="border: 1px solid;">
                                         ...
                                         <div class="col-sm-5" style="text-align: left;padding: 10px">
                                             ...
                                             <p class="margin_p"><b>T. Impuesto BCE: &nbsp;&nbsp;          </b><label id="RecargoTrimestral__mdpagos"></label></p>
            ...
            $.ajax({
                ...
                success: function( datos ){
                    ...
                    for( var i=0; i < datos.length ; i++ ){
                        $("#actividad").append('<option value="'+datos[i]['id'] +'">'+datos[i]['descripcion']+' </option>');
