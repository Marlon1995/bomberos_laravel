...
<head>
    ...
    <title>INSPECCIONES NO EMITIDAS</title>
    <style>
        html {
...
<body>
    <div id="content">
        ...
        <p class="cabeza__title"><b>Tipo Reporte: </b> &nbsp;INSPECCIONES NO EMITIDAS</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td><strong>${{ round($total_vpagos+$total_recargo+$total_especie+$total_especie , 2) }}</strong></td>
