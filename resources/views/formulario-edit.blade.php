                        ...
                        <!-- section nuevo clientes -->
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" method="POST" action="{{ route('formulario.update' , $client[0]->id)}}" enctype="multipart/form-data">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbInstacionesElectricas"
                                                ...
                                                <tr class="headings">
                                                    <th class="column-title cb-header-registe_description"><p
                                                                class="cb-subTitle">INSTALACIONES EL&Eacute;CTRICAS</p>
                                                    </th>
                                                    ...
                                                    @if($item->tipoRequerimiento == 'INSTALACIONES ELECTRICAS')
                                                        ...
                                                        <td>
                                                            <div class="col-md-2 col-sm-2 ">
                                                                <div class="checkbox">
                                                                    @if($item->respuesta == 1)
                                                                        <label><input type="radio" name="respuesta_{{$item->edit}}" value="1" class="flat" checked></label>
                                                                    @else
                                                                         <label><input type="radio" name="respuesta_{{$item->edit}}" value="1" class="flat" ></label>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-2 col-sm-2 ">
                                                                <div class="checkbox">
                                                                    @if($item->respuesta == 0)
                                                                        <label><input type="radio" name="respuesta_{{$item->edit}}" value="0" class="flat" checked></label>
                                                                    @else
                                                                        <label><input type="radio" name="respuesta_{{$item->edit}}" value="0" class="flat" ></label>
                                                                    @endif
                                                                 </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <textarea name="observacion_{{$item->edit}}" rows="5"
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbAlmacenamiento"
                                                   class="table table-striped jambo_table bulk_action"
                                                   style="width:100%">
                                                    <thead>
                                                    <tr class="headings">
                                                        <th class="column-title cb-header-registe_description"><p
                                                                    class="cb-subTitle">ALMACENAMIENTO </p></th>
                                                        <th class="column-title cb-header-register__tbSi">SI</th>
                                                        <th class="column-title cb-header-register__tbNo">NO</th>
                                                        <th class="column-title cb-header-register__tbObservacion">
                                                            OBSERVACIONES
                                                    ...
                                                    @forelse ($requerimientos as $item)
                                                        @if($item->tipoRequerimiento == 'ALMACENAMIENTO')
                                                            <tr class="even pointe">
                                                                ...
                                                                <td>
                                                                    <textarea name="observacion_{{$item->edit}}"
                                                                              rows="5"
                                                                              class="form-control col-md-12 col-sm-12 col-xs-12">{{$item->observacion}}</textarea>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbAlmaceammientoGLP"
                                                   class="table table-striped jambo_table bulk_action"
                                                   style="width:100%">
                                                <thead>
                                                <tr class="headings">
                                                    <th class="column-title cb-header-registe_description"><p
                                                                class="cb-subTitle">ALMACENAMIENTO DE G.L.P.</p></th>
                                                    <th class="column-title cb-header-register__tbSi">SI</th>
                                                    <th class="column-title cb-header-register__tbNo">NO</th>
                                                    <th class="column-title cb-header-register__tbObservacion">
                                                        OBSERVACIONES
                                                ...
                                                @forelse ($requerimientos as $item)
                                                    @if($item->tipoRequerimiento == 'ALMACENAMIENTO DE G.L.P.')
                                                        <tr data-fila="{{$item->id}}" class="even pointe">
                                                            ...
                                                            @if( $item->descripcion == 'CANTIDAD')
                                                                <td colspan="2">
                                                                    <input type="text" name="cantidad_{{$item->edit}}"  value="{{$item->cantidad}}" class="form-control">
                                                                </td>
                                                            @endif
                                                            <td>
                                                                <textarea name="observacion_{{$item->edit}}" rows="3"
                                                                          class="form-control col-md-12 col-sm-12 col-xs-12">{{$item->observacion}}</textarea>
                                                            </td>
                                                        </tr>
                                                    @endif
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbEquiposDeProteccion"
                                                ...
                                                <tr class="headings">
                                                    <th class="column-title cb-header-registe_description"><p
                                                                class="cb-subTitle">EQUIPOS DE PROTECCION Y CONTRA
                                                            INCENDIOS</p></th>
                                                    <th class="column-title cb-header-register__tbSi">SI</th>
                                                    <th class="column-title cb-header-register__tbNo">NO</th>
                                                    <th class="column-title cb-header-register__tbObservacion">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbExtintores" class="table table-striped jambo_table bulk_action"
                                                ...
                                                <tr>
                                                    <th class="column-title cb-header-registe_description"><p
                                                                class="cb-subTitle">EXTINTORES</p></th>
                                                            ...
                                                            @if( $item->descripcion != 'CANTIDAD')
                                                                @if( $item->respuesta == 1 )
                                                                    <td>
                                                                        <div class="col-md-2 col-sm-2 ">
                                                                            <div class="checkbox">
                                                                                <label><input type="radio" name="respuesta_{{$item->edit}}" value="1" class="flat" checked> SI </label>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="col-md-2 col-sm-2 ">
                                                                            <div class="checkbox">
                                                                                <label><input type="radio" name="respuesta_{{$item->edit}}" value="0" class="flat"> NO </label>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                @endif
                                                                ...
                                                                @if( $item->respuesta == 0 )
                                                                    <td>
                                                                        <div class="col-md-2 col-sm-2 ">
                                                                            <div class="checkbox">
                                                                                <label><input type="radio" name="respuesta_{{$item->edit}}" value="1" class="flat"> SI </label>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="col-md-2 col-sm-2 ">
                                                                            <div class="checkbox">
                                                                                <label><input type="radio" name="respuesta_{{$item->edit}}" value="0" class="flat" checked> NO </label>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    @endif
                                                                ...
                                                                <td rowspan="2">
                                                                    <textarea name="observacion_{{$item->edit}}"
                                                                              id="autocomplete-custom-append" rows="4"
                                                                              class="form-control col-md-12 col-sm-12 col-xs-12">{{$item->observacion}}</textarea>
                                                                </td>
                                                            @else
                                                                <td>
                                                                    <input type="text" name="cantidad_{{$item->edit}}" class="form-control" value="{{$item->cantidad}}">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="cantidadB_{{$item->edit}}" class="form-control" value="{{$item->cantidadB}}">
                                                                </td>
                                                            @endif
                                                        </tr>
                                                    @endif
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbRecursos" class="table table-striped jambo_table bulk_action"
                                                ...
                                                <tr class="headings">
                                                    <th class="column-title cb-header-registe_description"><p
                                                                class="cb-subTitle">RECURSOS</p></th>
                                                    <th class="column-title cb-header-register__tbSi">SI</th>
                                                    <th class="column-title cb-header-register__tbNo">NO</th>
                                                    <th class="column-title cb-header-register__tbObservacion">
                                                        OBSERVACIONES
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbCausales" class="table table-striped jambo_table bulk_action"
                                                ...
                                                <tr class="headings">
                                                    <th class="column-title cb-header-registe_description"><p
                                                                class="cb-subTitle">CAUSALES PARA RETIRO DE PERMISO DE
                                                            FUNCIONAMIENTOS</p></th>
                                                    <th class="column-title cb-header-register__tbSi">SI</th>
                                                    <th class="column-title cb-header-register__tbNo">NO</th>
                                                    <th class="column-title cb-header-register__tbObservacion">
                                                        OBSERVACIONES
                                            ...
                                            <h2 style="color: #ca1404">Nota: <small style="color:#2a3f54;"> Además, de cumplir con el pago del permiso del cuerpo de bomberos, tendrá que haber cancelado  las siguientes obligaciones:</small></h2>
                                        ...
                                        <h2 style="color: #ca1404">TIPO DE RIESGO </h2>
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-3 col-sm-3 ">
                                                <input type="hidden" value="{{$client[0]->riesgo_id}}" id="idMod__tipoNegocio">
                                        ...
                                        @if( !empty($fotosLocal[0]->path) )
                                            ...
                                            <div class="cjaFotosLocal">
                                                @if( !empty($fotosLocal[0]->path) )
                                                    Foto 1 <img src="/imgFormularios/{{$fotosLocal[0]->path}}" class="imgFotoLocal">
                                                @endif

                                                @if( !empty($fotosLocal[1]->path) )
                                                    Foto 2 <img src="/imgFormularios/{{$fotosLocal[1]->path}}" class="imgFotoLocal">
                                                @endif

                                                @if( !empty($fotosLocal[2]->path) )
                                                    Foto 3 <img src="/imgFormularios/{{$fotosLocal[2]->path}}" class="imgFotoLocal">
                                                @endif

                                                    <br>

                                                @if( !empty($fotosLocal[3]->path) )
                                                    Foto 4 <img src="/imgFormularios/{{$fotosLocal[3]->path}}" class="imgFotoLocal">
                                                @endif

                                                @if( !empty($fotosLocal[4]->path) )
                                                    Foto 5 <img src="/imgFormularios/{{$fotosLocal[4]->path}}" class="imgFotoLocal">
                                                @endif

                                                @if( !empty($fotosLocal[5]->path) )
                                                    Foto 6 <img src="/imgFormularios/{{$fotosLocal[5]->path}}" class="imgFotoLocal">
                                                @endif
