                        ...
                        <div class="col-md-4" id="fechasDiarias" style="display: none">
                            ...
                            <fieldset>
                                <div class="col-md-11 xdisplay_inputx form-group row has-feedback">
                                    <input type="text" class="form-control has-feedback-left fechaDiario" id="single_cal1" aria-describedby="inputSuccess2Status">
                                ...
                                <div class="control-group ">
                                    <div class="controls">
                                        <div class="input-prepend input-group">
                                            ...
                                            <input type="text" style="width: 200px" name="reservation" id="reservation" class="form-control fechaSemanalR" value="" />
                                        </div>
                                    </div>
                                </div>
...
@section('scrpts-jqrey')
    <script>
        ...
        $("#modoReporte").change( function () { $("#fechasDiarias").hide();     $("#fechasSemanales").hide();  });
        $("#tipoReporte").change( function () { $("#fechasDiarias").hide();     $("#fechasSemanales").hide();  });
