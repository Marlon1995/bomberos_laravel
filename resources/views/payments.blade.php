            ...
            <div class="x_panel">
                ...
                @if( auth()->user()->hasRoles([3]))
                    <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#clients" role="tab" aria-controls="home" aria-selected="true">Tasa Anual</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab" data-toggle="tab" href="#solicitudes" role="tab" aria-controls="home" aria-selected="true">Anticipos</a>
                        </li>
                    </ul>
                @endif
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbPagosTasaAnual" class="table table-striped jambo_table bulk_action" style="width:100%">
                                                <thead>
                                                    <tr class="headings">
                                                ...
                                                @forelse($impuestos  as $item)
                                                    <tr class="even pointer">
                                                        ...
                                                        <td><label class="valTasaAnual__tbPagos">{{$item->categoria}}</label> </td>
                                                        <td><label class="saldo__tbpagos">{{$item->denominacion}}</label></td>

                                                        <td>
                                                            <form method="POST" action="{{ route('payments.destroy', $item->id )}}">
                                                            <div data-toggle="modal"data-ruc_patototal="{{$item->id}}"  data-idCli="{{ $item->id }}" data-target="#mdlPagos" class="btn btn-info btn-xs btn-block pagar__pagos"> Facturar </div>

                                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                {!! method_field('DELETE') !!}
                                                                <button type="submit"class="btn btn-danger btn-xs btn-block ">Anular</button>
                                                            </form>
                                                            </td>
                            ...
                            <div class="">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <p class="text-muted font-13 m-b-30"></p>
                                        <div class="table-responsive">
                                            <table id="tbPagosSolicitudes" class="table table-striped jambo_table bulk_action" style="width:100%">
                                                <thead>
                                                    <tr class="headings">
                                                        <th class="column-title ruc__pagos">CI - RUC</th>
                                                        <th class="column-title ranSocial__pagos">RAZ&Oacute;N SOCIAL</th>
                                                ...
                                                @forelse($impuestos  as $item)
                                                     <tr class="even pointer">
                                                         ...
                                                         <td><label class="saldo__tbpagos">{{$item->denominacion}}</label></td>
                                                        <td>
                                                            <div data-toggle="modal" data-idCli="{{ $item->id }}" data-target="#mdlPagoSolicitud__pagos" class="btn btn-info mdlPagarSolicitud"> FACTURAR </div>
                                                         </td>
                                                    </tr>
                                                @empty
                                                @endforelse
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="page-title">
                                        ...
                                        <div class="title_right">
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group pull-right top_search">
                                                <div class="input-group">
                                                    <input type="text" class="form-control"placeholder="Buscar por.." value="" id="tbClientesSecretario_InpBuscar">
                                                    <span class="input-group-btn">
                                                        <button class="btn" type="button">Buscar</button>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbClienteSecretario" class="table table-striped jambo_table bulk_action" style="width:100%">
                                                <thead>
                                                    <tr class="headings">
                                                        <th class="column-title ruc__pagos">CI - RUC</th>
                                                        <th class="column-title ranSocial__pagos">RAZ&Oacute;N SOCIAL</th>
                                                ...
                                                <tbody>
                                                    @forelse ($impuestos as $item)
                                                        <tr class="evenpointer">
                                                            ...
                                                            <td><label class="saldo__tbpagos">{{$item->denominacion}}</label></td>
                                                            <td>
                                                                <div class="btn btn-info btnmdlSolicitud__pagos" data-toggle="modal"
                                                                     data-ruc_patototal="{{$item->id}}"
                                                                     data-idCli="{{ $item->id }}" data-target="#mdlSolicitud__pagos" > DESCUENTO </div>
                                                            </td>
                                ...
                                <div class="col-sm-6" style="text-align: center">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row" style="border: 1px solid;">
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-5" style="text-align: left;padding: 10px">
                                                <p class="margin_p"><b>T. Anticipos:    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b> <label id="anticipos__mdpagos"></label></p>
                                                <p class="margin_p"><b>T. Descuentos:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </b><label id="descuentos__mdpagos"></label></p>
                                                <p class="margin_p"><b>Recargo: &nbsp;&nbsp;               </b><label id="RecargoTrimestral__mdpagos"></label></p>
                                                <p class="margin_p"><b>T. Tasa Anual:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </b><label id="TasaAnual__mdpagos"></label></p>

                                                <p class="margin_p"><b>Valor Especie:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </b><label>$ 2.00</label></p>
                                                <p class="margin_p"><b>Valor P. Exoneracion:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </b><label id="permiso">$ 1.00</label></p>

                                                <p class="margin_p"><b>Valor Tasa Anual: &nbsp;&nbsp;&nbsp;</b><label id="TotalTasaAnual__mdpagos"></label></p>
                                            </div>
                                        ...
                                        <form method="POST" action="{{ route('payments.update', 2 )}}">
                                            ...
                                            <div class="row" style="border: 1px solid;">
                                                ...
                                                <div class="col-sm-19" style="text-align: left;padding: 10px">
                                                    ...
                                                    <div class="item form-group">
                                                        <label class="col-form-label col-md-4 col-sm-4 label-align" for="cedula">F.Pago</label>
                                                        <div class="col-md-10 col-sm-10">
                                                            <select class="form-control" name="formaPago" id="formaPago_1">
                                                    ...
                                                    <div class="item form-group numTransaccion_1CAJA">
                                                        <label class="col-form-label col-md-4 col-sm-4 label-align" for="cedula">N. Trans #</label>
                                                        <div class="col-md-10 col-sm-10">
                                                            <input type="text" class="form-control numTransaccion_1" name="numTransaccion" id="numTransaccion_1"  onKeyPress="return fn_aceptaNum(event)"  value="" placeholder="N&uacute;mero de Transacci&oacute;n">
                                                        </div>
                                                    </div>
                                              
                                                    <div class="item form-group numTransaccion_1CAJA">
                                                        <label class="col-form-label col-md-4 col-sm-4 label-align" for="cedula">Pocentaje Recargo: </label>
                                                        <div class="col-md-10 col-sm-10">
                                                        <input type="text" class="form-control datepicker" name="valor_porcentaje" id="valor_porcentaje" required placeholder="1.46% ">
                                                    ...
                                                    <div class="item form-group">
                                                        <label class="col-form-label col-md-4 col-sm-4 label-align" for="cedula">N. P. F #</label>
                                                        <div class="col-md-10 col-sm-10">
                                                            <input type="hidden" class="form-control" name="valor__tbPagos" id="valor__tbPagos_a_1" value=""  onKeyPress="return fn_aceptaNum(event)"  placeholder="Valor ej. 10.50" style="text-align: center"   >
                                                            <input type="text" class="form-control" name="numPermisoFuncionamiento" id="numPermisoFuncionamiento_1" value=""  onKeyPress="return fn_aceptaNum(event)" required placeholder="Número de Permiso de Funcionamiento" style="text-align: center" >
                                                        </div>
                                                    </div>
                                            ...
                                            <input type="submit" value="FACTURAR" class="btn btn-info" style="font-size: 55px">
                                        </form>
                                ...
                                <div class="col-sm-6" style="text-align: center">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row" style="border: 1px solid;">
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-5" style="text-align: left;padding: 10px">
                                                <p class="margin_p"><b>T. Anticipos:    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     </b> <label id="anticipos__mdpagos_m"></label></p>
                                                <p class="margin_p"><b>T. Descuentos:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;       </b>$ <label id="descuentos__mdpagos_m"></label></p>
                                                <p class="margin_p"><b>T. Impuesto BCE: &nbsp;&nbsp;           </b><label id="RecargoTrimestral__mdpagos_m"></label></p>
                                                <p class="margin_p"><b>T. Tasa Anual:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;       </b><label id="TasaAnual__mdpagos_m"></label></p>
                                                <p class="margin_p"><b>Valor Tasa Anual: &nbsp;&nbsp;&nbsp;         </b><label id="TotalTasaAnual__m_"></label></p>

                                            </div>
                                            <div class="col-sm-5" style="text-align: center;">
                                                <br><br>
                                                <p style="font-size: 20px; font-weight: bold"><b>TOTAL: </b>$ <label id="saldo__mdpagos_m" name="saldo__mdpagos_m"></label></p>
                                            </div>

                                            <div class="col-sm-1"></div>
                                        </div>

                                         <form method="POST" action="{{ route('payments.update', 2 )}}" enctype="multipart/form-data">
                                            ...
                                            {!! method_field('PUT') !!}
                                                <div class="row" style="border: 1px solid;">
                                                    ...
                                                    <div class="col-sm-5" style="text-align: left;padding: 10px">
                                                        ...
                                                        <div class="item form-group">
                                                            <label class="col-form-label col-md-4 col-sm-4 label-align" for="cedula">Porcentaje </label>
                                                            <div class="col-md-10 col-sm-10">
                                                                <input type="text" name="cliend_idmp" id="valor__mdlSolicutudPago_mp" value="" required placeholder="Porcentaje % ej. 10.5"  style="text-align: center" onKeyPress="return fn_aceptaNum(event)" >
                                                                <input type="hidden" name="valor__tbPagos" id="valor__tbPagos_mp" value="0">
                                                                <input type="hidden" name="cliend_idmp" id="cliend_idmp" value="">
                                                            </div>
                                                        </div>
                                                        <div class="item form-group">
                                                            <label class="col-form-label col-md-4 col-sm-4 label-align" for="cedula">Tipo Descuento </label>
                                                            <div class="col-md-10 col-sm-10">
                                                        ...
                                                        <div class="item form-group">
                                                            <label class="col-form-label col-md-4 col-sm-4 label-align" for="cedula">Respaldo </label>
                                                            <div class="col-md-10 col-sm-10">
                                                     ...
                                                     <div class="col-sm-5" style="text-align: center;">
                                                         <p style="font-size: 20px; font-weight: bold"><b>VALOR: </b><label name="saldo__mdpagos_mp" id="saldo__mdpagos_mp"></label></p>
                                                    </div>
                                            ...
                                            <input type="submit" value="GENERAR" class="btn btn-info" style="font-size: 55px">
                                        </form>
                                ...
                                <div class="col-sm-6" style="text-align: center">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row" style="border: 1px solid;">
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-5" style="text-align: left;padding: 10px">
                                                <p class="margin_p"><b>T. Anticipos:    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        </b>$ <label id="anticipos__mdpagos_a"></label></p>
                                                <p class="margin_p"><b>T. Descuentos:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;           </b><label id="descuentos__mdpagos_a"></label></p>
                                                <p class="margin_p"><b>T. Impuesto BCE: &nbsp;&nbsp;               </b><label id="RecargoTrimestral__mdpagos_a"></label></p>
                                                <p class="margin_p"><b>T. Tasa Anual:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;           </b><label id="TasaAnual__mdpagos_a"></label></p>
                                                <p class="margin_p"><b>Valor Tasa Anual: &nbsp;&nbsp;&nbsp;             </b><label id="TotalTasaAnual__mdpagos_a"></label></p>


                                            </div>
                                            <div class="col-sm-5" style="text-align: center;">
                                                <br><br>
                                                <p style="font-size: 20px; font-weight: bold"><b>TOTAL: </b>$ <label id="saldo__mdpagos_a"></label></p>
                                            </div>
                                            <div class="col-sm-1"></div>
                                        </div>
                                        ...
                                        <form method="POST" action="{{ route('payments.update', 2 )}}">
                                            ...
                                            <div class="row" style="border: 1px solid; padding: 10px">
                                                ...
                                                <div class="col-sm-5" style="text-align: left;padding: 10px">
                                                    ...
                                                    <input type="text" class="form-control" name="numTransaccion" id="numTransaccion"  onKeyPress="return fn_aceptaNum(event)"  value="" placeholder="N&uacute;mero de Transacci&oacute;n" style="margin: 5px 0px">
                                                ...
                                                <div class="col-sm-5" style="text-align: center;">
                                                    ...
                                                    <input type="text" class="form-control" name="valor__tbPagos" id="valor__tbPagos_a" value=""  onKeyPress="return fn_aceptaNum(event)"  required placeholder="Valor ej. 10.50" style="text-align: center" >
                                                </div>
                                                <div class="col-sm-1"></div>
                                            </div>
