...
@section('pagecontent')
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title"><i class="fa fa-usd"></i> PAGOS | TASAS POR CONCESION DE PERMISOS DE
                FUNCIONAMIENTO ANUALES</h4>
                    ...
                    <tr>
                        <td>
                            <table border="0" align="left" class="td__pagos">
                                <tr>
                                    <th><b>Raz&oacute;n Social___________</b> Desarrollo de Software y Talleres</th>
                                </tr>
                                <tr>
                                    <th><b>Representante Legal__</b> Jeison Isidro Caguana Guaman</th>
                                </tr>
                                <tr>
                                    <th><b>Denominaci&oacute;n_________</b> Comercial</th>
                                </tr>
                                <tr>
                                    <th><b>Categor&iacute;a_____________</b> AAA</th>
                                </tr>
                                <tr>
                                    <th><b>Riesgo________________</b> AEI</th>
                                </tr>
                            </table>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table border="0" align="left" class="td__pagos" style="margin-left: 15px">
                                <tr>
                                    <th><b>TOTAL</b>_______$ 23,00</th>
                                </tr>
                                <tr>
                                    <th><b>IVA 12%</b>_____$ 2,00</th>
                                </tr>
                                <tr>
                                    <th><b>TOTAL + IVA</b>_$ 23,00</th>
                                </tr>
                                <tr>
                                    <td><br></td>
                                </tr>
                                <tr>
                                    <td>
                                        <button class="btn btn-outline-success"><i class="fa fa-check"></i>
                                            Pagar</button>
                                    </td>
                                </tr>
                            </table>
